...
app.post("/pegawai", (req, res) => {
    ...
    let sql = "select * from pegawai where id_pegawai like '%" +find+
    "%' or nama_pegawai like '%" +find+ "%' or alamat like '%" +find+"%'"
...
// DELETE: /pegawai/:id_siswa --> end point untuk hapus data pegawai
